...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '69862dd9f4e1480a8c0c2d73601936ee',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '我是一个电厂打工人,分享热控知识、经验总结，欢迎来到我的博客🎉',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个电厂热控打工人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.homen1.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,热控知识库', // 网站关键词 英文逗号隔开
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/birdxs', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  COMMENT_GITALK_REPO: process.env.NEXT_PUBLIC_COMMENT_GITALK_REPO || '热控知识库', // 你的Github仓库名，例如 'NotionNext'
